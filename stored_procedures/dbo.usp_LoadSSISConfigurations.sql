...
1.4 	 03/27/2021  UUDO		   1. Added LoadNAISCodeHierDim_uu configuration
...
-- (3.4) LoadNAISCodeHierDim_uu
		
    DELETE FROM dbo.[SSIS Configurations]
     WHERE ConfigurationFilter = 'LoadNAISCodeHierDim_uu';
    ...
    VALUES
          (
           'LoadNAISCodeHierDim_uu'
		 , 'C:\LDSBC\IT243\repos\DFNB_dw_uu\xls.files\'
         , '\Package.Variables[User::v_data_share_root].Properties[Value]'
         , 'String'
          );
